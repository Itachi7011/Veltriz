const appName = process.env.APP_NAME || 'Veltriz Admin';
      ...
      <tr>
        <td align="center">
          <table width="480" cellpadding="0" cellspacing="0" style="background:#131722;border-radius:12px;overflow:hidden;border:1px solid #1f2433;">
            <tr>
              <td style="background:linear-gradient(135deg,#0ea5e9,#7c3aed);padding:24px 32px;">
                <h1 style="margin:0;color:#fff;font-size:20px;letter-spacing:1px;">${appName}</h1>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:16px 32px;background:#0e1119;color:#64748b;font-size:12px;">
                Admin panel security notice — if you didn't request this, contact your team lead immediately.
              </td>
            </tr>
          </table>
        </td>
...
const adminResetPasswordTemplate = ({ username, resetUrl }) =>
  baseWrapper(
    'Reset your admin password',
    `
    <p>Hey ${username},</p>
    <p>We received a request to reset your Veltriz admin password.</p>
    <p style="text-align:center;margin:28px 0;">
      <a href="${resetUrl}" style="background:#0ea5e9;color:#0b0e14;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:bold;">
        Reset Password
      </a>
    </p>
...
module.exports = { adminResetPasswordTemplate };
